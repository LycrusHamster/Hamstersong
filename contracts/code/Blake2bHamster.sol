...
contract HasmterBlake2b {
    ...
    event Result(bytes32 ret,uint256 gas);


    function digest208(bytes memory input208) internal returns (bytes32 ret){
        assembly{
        ...
        // pass memory to blake2b, get the result h at 0x80+0x04, over-writing
            log1(memory_ptr,0xD5,0x955c1b5a510509161a657fe18d67794291ab2a6f28587478593353970a00d47f)
    ...
    function digest64(bytes memory input64) internal returns (bytes32 ret){
        assembly{
        // reject not ckbinput
        // 64 = 0x40
